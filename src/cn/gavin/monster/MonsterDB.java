...
public class MonsterDB {
    ...
    public static void addMonster(SQLiteDatabase database) {
        ...
        database.execSQL(String.format(sql, 41, "蛇", 200, 380, 200, "硝石", "", 240, 0,"滑溜溜的。",R.drawable.se_lv));
        database.execSQL(String.format(sql, 14, "猴", 210, 310, 300, "硝石", "", 280, 0,"喜欢躲在阴暗处丢石头。似乎有一点点的智慧，据说是从外面世界逃进迷宫的人类？",R.drawable.hou));
        ...
        database.execSQL(String.format(sql, 42, "精灵", 2500, 4000, 201, "硝石", "", 109, 0,"美貌与身材兼具的生物，但是它们可是很凶残的。",R.drawable.jingling_lv));
        ...
        database.execSQL(String.format(sql, 27, "朱厌", 6500, 60000, 101, "硝石", "", 121, 2,"朱厌是古代汉族神话传说中的凶兽,身形像猿猴,白头红脚。据说在迷宫世界中被创造出来最初的目的是用作为守护者存在的。",R.drawable.zhuyan));
        ...
        database.execSQL(String.format(sql, 30, "山魁", 20000, 50000, 105, "硝石", "", 120, 4,"山魈其实就是凶狠的大猴子，丑得让人看见就想哭。据说是堕落的勇者失去理智之后的形成的",R.drawable.shankui));
        database.execSQL(String.format(sql, 39, "穷奇", 90000, 100000, 98, "硝石", "穷奇，汉族神话传说中的古代四凶之一，外貌像老虎又像牛，长有一双翅膀和刺猬的毛发，代表至邪之物。据说这种生物并不是创造出来的", 100, 5,"",R.drawable.qiongqi));
        database.execSQL(String.format(sql, 98, "穷奇", 90000, 100000, 98, "硝石", "穷奇，汉族神话传说中的古代四凶之一，外貌像老虎又像牛，长有一双翅膀和刺猬的毛发，代表至邪之物。据说这种生物并不是创造出来的", 100, 5,"",R.drawable.qiongqi_red));
        database.execSQL(String.format(sql, 38, "九尾狐", 100000, 300000, 59, "硝石", "", 99, 30,"九尾狐，中华古代汉族神话传说中的生物--青丘之山，有兽焉，其状如狐而九尾。在迷宫创造者消失后才出现的生物。",R.drawable.jiuweihu));
        database.execSQL(String.format(sql, 99, "九尾狐", 100000, 300000, 59, "硝石", "", 99, 30,"九尾狐，中华古代汉族神话传说中的生物--青丘之山，有兽焉，其状如狐而九尾。在迷宫创造者消失后才出现的生物。",R.drawable.jiuweihu_red));
        database.execSQL(String.format(sql, 100, "猼訑", 110000, 600000, 78, "硝石", "", 89, 7,"猼訑（bódàn）是古代汉族神话传说中一种样子像羊的怪兽。它有九条尾和四只耳朵，眼睛长在背上。据说是由迷宫创造者设立作为图腾的生物。",R.drawable.fudi));
        ...
        database.execSQL(String.format(sql, 103, "梼杌", 200000, 800000, 21, "硝石", "", 15, 40,"梼杌(táowù)是上古时期华夏神话中的四凶之一。长得很像老虎，毛长，人面、虎足、猪口牙，尾长。传说中的神死亡后其精神分化形成的",R.drawable.taowu));
    }
}

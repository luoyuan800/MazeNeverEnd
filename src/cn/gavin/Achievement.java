...
public enum Achievement {
    ...
    rich("富裕", "持有5000000锻造点数。小心！锻造点数太多会吸引那些强大又贪婪的怪物或者人。", 0, 0, 0, 0),
    ...
    cribber("作弊者", "作弊可耻！修改游戏也是很无聊的！你的游戏数据被判定为异常！", -1000000000, -1000000000, -100000000,0),
    ...
    restriction("相克", "你又遇见了那个烦人的NPC龙剑森，他再赠送了你三把钥匙，虽然你非常的不想要，但他还是把钥匙砸在了你的脸上……" +
            "因为他是NPC。而且他还会告诉你五行相克：金克木，木克土，土克水，水克火，火克金，无被所有克。那么问题来了，为什么这些NPC都要躲在门后面呢？", 0, 0, 0,0),
    EMPTY("", "", 0, 0, 0, 0);

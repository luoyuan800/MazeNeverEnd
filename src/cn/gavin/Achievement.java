...
public enum Achievement {
    ...
    speculator("投机者", "到达迷宫100层的时候武器和防具的等级均为0", 0, 100, 100, 0),
    ...
    hero("勇者", "学习并且使用了勇者技能", 0, 0, 0, 0),
    devils("魔王", "学习并且使用了了魔王技能", 0, 0, 0, 0),
    R_hero("真勇者", "学习并且使用了最后一个勇者职业的技能", 0, 0, 0, 0),
    satan("撒旦", "学习并且使用了了最后一个魔王职业技能", 0, 0, 0, 0),
    story("主线剧情", "恭喜你触发了主线剧情！什么？你以为这个游戏没有主线？那你就错了！", 0, 0, 0, 0),
    swindler("欺诈师", "学习并且使用了欺诈师技能！", 0, 0, 0, 0),
    cribber("作弊者", "游戏数据被判定为异常！", -10000000, -10000000, -100000000,0),
    dragon("屠龙者", "在游戏中击败了5000条龙！", 0, 0, 0,0),
    EMPTY("", "", 0, 0, 0, 0);

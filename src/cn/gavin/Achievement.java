...
public enum Achievement {
    ...
    guider1("新手指导", "你遇见了NPC袁酥兄，他拿走了你两把钥匙和告诉了你这个游戏的基本玩法，" +
            "比如点击右上角的名字栏你可以更改名字或者输入隐藏代码获取奖励、可以长按战斗信息栏隐藏战斗信息、" +
            "可以点击人物图标获取奖励的锻造点数和能力点数、可以点击锁头图标开启宝箱、点击技能图标可以加速技能的升级。", 0, 0, 0,0),
    guider2("NPC", "你再次遇见了NPC袁酥兄，虽然你很想避开他，但他还是拿走了你四把钥匙并且悄悄的告诉你，" +
            "已经没有什么可以教给你的了，有问题就去问其他人吧……" +
            "于是你狠狠的揍了他一顿，并且抢走他的一个宝箱，但是还是没有拿回你的钥匙……", 0, 0, 0,0),

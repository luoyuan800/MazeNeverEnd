...
public enum Achievement {
    ...
    guider1("新手指导", "你用钥匙打开了一扇门，在门后你遇见了NPC袁酥兄，他告诉了你这个游戏的基本玩法，" +
    ...
    guider2("NPC", "你用钥匙打开了一扇门，在门后你再次遇见了NPC袁酥兄，但没想到他拿走了你四把钥匙并且悄悄的告诉你，" +
            "已经没有什么可以教给你的了，有问题就去问其他人吧……", 0, 0, 0, 0, "遇见剧情NPC解锁", 0, 0f, 0),
    guider3("打造攻略", "你用钥匙打开了一扇门，在门后你再再次遇见了NPC袁酥兄，我知道你很想揍他，但他还是拿走了你一半的钥匙并且悄悄的告诉你，" +
    ...
    five("五行", "你用钥匙打开了一扇门，在门后你遇见了NPC龙剑森，他赠送了你三把钥匙并且告诉了五行的秘密。在这个世界里，" +
            "人物和怪物的五行属性会影响攻击和防御的计算。而装备的五行属性会影响隐藏属性的激活。", 0, 0, 0, 0, "遇见隐藏NPC解锁", 0, 0f, 0),
    reinforce("相生", "你用钥匙打开了一扇门，在门后你又遇见了NPC龙剑森，他又赠送了你三把钥匙，虽然你不是很想要，但是你没办法拒绝……" +
            "因为他是NPC。而且他还会告诉你错误的五行相生：金生水，木生水，火生金，土生金，水生木。请你不要相信他……", 0, 0, 0, 0, "遇见隐藏NPC解锁", 0, 0f, 0),
    restriction("相克", "你用钥匙打开了一扇门，在门后你又遇见了那个烦人的NPC龙剑森，他再赠送了你三把钥匙，虽然你非常的不想要，但他还是把钥匙砸在了你的脸上……" +
            "因为他是NPC。而且他还会告诉你五行相克：金克木，木克土，土克水，水克火，火克金，无被所有克。那么问题来了，为什么这些NPC都要躲在门后面呢？", 0, 0, 0, 0, "遇见隐藏NPC解锁", 0, 0f, 0),
    palace("殿堂屠夫", "击败殿堂里面的大部分人，增加10点击奖励", 0, 0, 0, 10, "击败50%其他玩家上传的人物。", 0, 0f, 0),
    ...
    FShengShou("次神兽", "次神兽无法正常捕获，但是你依然拥有次神兽作为宠物...增加宠物变异几率。", 0, 0, 0, 0, "拥有朱厌或者穷奇", 0f, 5f, 0),
    ...
    Tire("伤心", "心好累，游戏老是出bug，改都改不过来……增加宠物捕获率", 0, 0, 0, 0, "遇见了心好累的作者", 0.5f, 0f, 0),
    anger("愤愤然", "老是被人嫌弃，还只能蹲墙角画圈圈……增加宠物变异率", 0, 0, 0, 0, "遇见了愤怒的作者", 0f, 5f, 0),
    Shop("商店", "开启随机商店，随机商人进驻之后会一直等候你直到你访问商店之后才会离开。", 0, 0, 0, 0, "成功进入商店", 0f, 0f, 0),
    Master("挑战群主", "一声令下，灰飞烟灭。干掉他获得称号。", 0, 0, 0, 0, "遇见隐藏人物", 0f, 0f, 0),
    GameEnd("通关", "恭喜你通关，拜拜！三围各减少7000000。", -700000, -700000, -700000, 0, "在持有所有的33种物品的情况下激活孩子王天赋", 0f, 0f, 0),
